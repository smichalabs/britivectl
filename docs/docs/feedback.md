...
This opens the new-issue page on the [bctl issue tracker](https://github.com/smichalabs/britivectl/issues) with the bug template selected and an environment block already in the body:
...
Issues land on the public [`smichalabs/britivectl`](https://github.com/smichalabs/britivectl) repository. Both maintainers are auto-assigned and notified.
